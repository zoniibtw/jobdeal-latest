    ...
    return (
        <section className="mx-auto flex flex-col items-center">
            <div className="container">
                <div className="w-full rounded-lg bg-black p-16 flex justify-between items-center">
                        ...
                        <div className="absolute h-full w-full">
                            <div className="w-full h-full flex flex-col justify-center gap-12 px-9">
                                <div className="w-full flex justify-end">
                                    <div className="border-green-500 border py-2 px-6 rounded text-white bg-white/15 backdrop-blur-sm">
